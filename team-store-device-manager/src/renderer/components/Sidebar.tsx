...
import {
  ...
  BarChart3, Search, Settings, HardDrive, LogOut, ChevronLeft, Store
} from 'lucide-react'
    ...
    >
      ...
      <div className="border-t border-slate-700 p-3">
        ...
        <button
          ...
          className="flex items-center gap-3 w-full px-3 py-2 rounded-lg text-sm text-slate-300 hover:bg-slate-800 hover:text-white transition-all"
        >
